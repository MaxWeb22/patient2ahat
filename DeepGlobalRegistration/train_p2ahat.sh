...
export DATASET=${DATASET:-p2ahatDataset}
export P2AHAT_DIR="/home/weber/Documents/Git/Image2Patient/Benchmark-Method/DeepGlobalRegistration/training_data/p2ahat"
export MODEL=${MODEL:-ResUNetBN2C}
export MODEL_N_OUT=${MODEL_N_OUT:-32}
export FCGF_WEIGHTS="/home/weber/Documents/Git/Image2Patient/Benchmark-Method/DeepGlobalRegistration/ResUNetBN2C-feat32-3dmatch-v0.05.pth"
export INLIER_MODEL=${INLIER_MODEL:-ResUNetBN2C}
export OPTIMIZER=${OPTIMIZER:-SGD}
export LR=${LR:-1e-1}
export MAX_EPOCH=${MAX_EPOCH:-300}
export BATCH_SIZE=${BATCH_SIZE:-30}
export VAL_BATCH_SIZE=${VAL_BATCH_SIZE:-9}
export ITER_SIZE=${ITER_SIZE:-1}
export VOXEL_SIZE=${VOXEL_SIZE:-0.05}
export POSITIVE_PAIR_SEARCH_VOXEL_SIZE_MULTIPLIER=${POSITIVE_PAIR_SEARCH_VOXEL_SIZE_MULTIPLIER:-5}
